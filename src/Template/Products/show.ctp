						...
						<div class="photo">
							...
							<div class="item">
								<a href="#">
									...
									<?= $this->Html->link($this->Html->image($product['thumb']), "/san-pham/" . $product['slug'], ['escape' => false]); ?>
								</a>
							</div>
						</div>
						<div class="info">
							<div class="row">
								<div class="price-details col-md-12">
									<div class="text-center">
										<div class="col-md-9 rating text-center">
											<select class="rating-stars">
												<option value="1">1</option>
												<option value="2">2</option>
												<option value="3" selected>3</option>
							...
							<div class="separator clear-left">
								<div class="price-details col-md-6">
									...
									<span class="text-center">Mua sản phẩm tại <a href="<?=$product['crawl_url'] ?>" target="_blank">Gmarket</a></span>
								</div>
							</div>
							<div class="clearfix"></div>
						</div>
